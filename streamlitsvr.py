...
def run_all_svr_analysis(df_clean, selected_feature, selected_target):
    ...
    for kernel in kernels:
        ...
        elif kernel == 'poly': svr = SVR(kernel=kernel, C=10, degree=1, gamma=0.05)
        elif kernel == 'rbf': svr = SVR(kernel=kernel, C=10, gamma=0.05)
        elif kernel == 'sigmoid': svr = SVR(kernel=kernel, C=10, gamma=0.05, coef0=0)
