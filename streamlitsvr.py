...
def run_all_svr_analysis(df_clean, selected_feature):
    ...
    for kernel in kernels:
        ...
        elif kernel == 'poly': svr = SVR(kernel=kernel, C=10, degree=2, gamma=0.5)
        elif kernel == 'rbf': svr = SVR(kernel=kernel, C=10, gamma=0.5)
        elif kernel == 'sigmoid': svr = SVR(kernel=kernel, C=1, gamma=0.5, coef0=0)
